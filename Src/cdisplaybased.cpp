...
//----------------------------------------------------------------------------------------------------
void CDisplayBased::PutSymbol(int32_t x,int32_t y,char symbol,uint16_t color)
{
 ...
 for(int32_t ys=0;ys<FONT_HEIGHT;ys++)
 {
  ...
  {   
   if (x+xs<0 || x+xs>=DISPLAY_WIDTH) continue;
   if (y+ys<0 || y+ys>=DISPLAY_HEIGHT) continue;
   if (byte&mask) PutPixel(x+xs,y+ys,color);
  }
 }	
}
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
void CDisplayBased::PutString(int32_t x,int32_t y,const char *string,uint16_t color)
{
 uint32_t s=0;	
 while((*string)!=0)
 {
...
//----------------------------------------------------------------------------------------------------
void CDisplayBased::Print(const char *string,uint16_t color)
{
 if (PrintYPosition+FONT_HEIGHT>=DISPLAY_HEIGHT) Clear(ClearColor);
...
//----------------------------------------------------------------------------------------------------
void CDisplayBased::Clear(uint16_t color)
{
 PrintYPosition=0;
 ClearColor=color;	
 ...
 {
  for(uint32_t x=0;x<DISPLAY_WIDTH;x++) OutColor(color);
 }
}
