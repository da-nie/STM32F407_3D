...
//----------------------------------------------------------------------------------------------------
inline void IL9325_SetData(unsigned char byte)
{
...
//передать байт
//----------------------------------------------------------------------------------------------------
inline void IL9325_Write8(unsigned char byte)
{ 
 IL9325_SetData(byte);
 IL9325_WR_Zero();
 IL9325_WR_One();
...
//передать 16 бит 
//----------------------------------------------------------------------------------------------------
inline void IL9325_Write16(unsigned short value) 
{ 
...
//----------------------------------------------------------------------------------------------------
inline void IL9325_WriteRegister16(unsigned short reg,unsigned short value) 
{ 
 IL9325_RS_Zero();
 IL9325_Write16(reg);
 IL9325_RS_One();
...
//----------------------------------------------------------------------------------------------------
inline void IL9325_WriteRegister8(unsigned char reg,unsigned char value) 
{ 
 IL9325_RS_Zero();
 IL9325_Write8(reg);
 IL9325_RS_One();
...
void IL9325_SetWindow(unsigned short x_left,unsigned short y_top,unsigned short x_right,unsigned short y_bottom)
{
 ...
 IL9325_RS_Zero();
 IL9325_Write16(ILI932X_RW_GRAM); 
...
void IL9325_PutSymbol(long x,long y,char symbol,unsigned short color)
{
 ...
 for(long ys=0;ys<FONT_HEIGHT;ys++)
 {
  ...
  {   
   if (x+xs<0 || x+xs>=IL9325_WIDTH) continue;
   if (y+ys<0 || y+ys>=IL9325_HEIGHT) continue;
   if (byte&mask) IL9325_PutPixel(x+xs,y+ys,color);
  }
 }	
}
//----------------------------------------------------------------------------------------------------
...
{
 if (PrintYPosition+FONT_HEIGHT>=IL9325_HEIGHT) IL9325_Clear();
...
void IL9325_Clear(void)
{
 ...
 //передаём данные картинки
 IL9325_RS_One();
 for(long y=0;y<IL9325_HEIGHT;y++)
 {
  for(long x=0;x<IL9325_WIDTH;x++)
  {
		IL9325_Write16(IL9325_BLACK);
  }
 }
}
